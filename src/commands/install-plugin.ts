...
export async function installPluginCommand(
  ...
  console.log('  Slash commands: /grab-ticket, /plan-ticket, /complete-ticket, /create-ticket, /create-project, /track-session, /clear-ticket, /replan, /resume-session, /syntaur-worktree, /list-tickets, /log-progress, /set-workspace');
