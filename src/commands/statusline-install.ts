...
import { writeDefaultConfigIfMissing } from './statusline-configure.js';
...
function getPackageStatuslineSource(): string {
  ...
  // `dist/commands/statusline-install.js` during build bundles everything into
...
export async function installStatuslineCommand(
  ...
  // customize later via `syntaur statusline configure`. If a config already
