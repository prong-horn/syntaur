...
const COMMAND_FLAGS: Record<string, readonly string[]> = {
  ...
  approve: ['--force', '--by', '--project', '--no-dispatch'],
  start: ['--force', '--by', '--project', '--agent', '--no-dispatch'],
  review: ['--force', '--by', '--project', '--no-dispatch'],
  done: ['--force', '--by', '--project', '--no-dispatch'],
  drop: ['--force', '--by', '--project', '--no-dispatch'],
  reopen: ['--force', '--by', '--project', '--no-dispatch'],
