...
function runReconcile(): void {
  ...
  activeReconcile = reconcile(opts.serversDir, opts.missionsDir, opts.excludePids)
    .catch((err) => {
...
async function reconcile(serversDir: string, missionsDir: string, excludePids?: Set<number>): Promise<void> {
