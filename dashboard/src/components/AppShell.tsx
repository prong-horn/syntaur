...
import { Activity, Archive, BookOpen, Boxes, Brain, CheckSquare, Coins, Compass, FolderKanban, LayoutTemplate, LifeBuoy, Library, ListTodo, Monitor, Plus, Settings, X, ChevronDown, Trash2 } from 'lucide-react';
