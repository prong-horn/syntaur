...
description: >-
  ...
  meaningful action per the Keep Records Updated playbook. Triggers on "log
  progress", "note progress", "record this in progress", or whenever the
  playbook says to update records.
license: MIT
metadata:
  author: prong-horn
  version: "2.0.0"
