---
description: Append a timestamped entry to the active ticket's progress.md and bump frontmatter
---

# /log-progress

Append a structured timestamped entry to `<ticketDir>/progress.md` and bump its `entryCount` and `updated` frontmatter fields. Implements the Keep Records Updated playbook.
