...
This is the most important rule in the protocol. The `status`, `priority`, `assignee`, `dependsOn`, `workspace`, and all other structured fields in a ticket's YAML frontmatter are canonical. Every other representation of this data is a projection:
